<?php
// PSR-0 AUTOLOADER (based on NAMESPACES)
//
...
if ($check === true) {
  $joe = new Acme\App\User($data); // new namespaced class
  ...
  //
  $nick = new Acme\Library\User(); // new object based on Acme/Library/User class
  print_r($nick);
} else {
  var_dump($validator->getErrors());
}