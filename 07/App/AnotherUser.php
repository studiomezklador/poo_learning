...
class AnotherUser {
	...
	private $email;
	private $pwd;
	private $fillable = array('email'); // kind of rules to allow modifications on this class properties, declared here
	private $allowed = array('pwd'); // rules to allow __get method to return ONLY those values
